...
export const SITE_UI = {
  ...
  apps: {
    ...
    fields: [
      ...
      { kind: "message", app: "WhatsApp", text: "Running ten late, order for me?" },
      { kind: "memo", app: "Reminders", text: "Call Amma before nine." },
      { kind: "search", app: "Maps", text: "Chai near me, open now" },
      { kind: "mail", app: "Mail", to: "To: Landlord", text: "Rent goes out on the first, as always." },
      { kind: "message", app: "Slack", text: "PR is up. Two files, no migrations." },
      { kind: "memo", app: "Notes", text: "Milk, dahi, two lemons, batteries." },
      { kind: "search", app: "YouTube", text: "How to fix a squeaky door" },
      { kind: "message", app: "Message", text: "Hum paanch minute mein pahunch rahe hain." },
    ],
  },
  desk: {
