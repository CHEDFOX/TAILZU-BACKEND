...
export const SITE_UI = {
  ...
  apps: {
    ...
    fields: [
      ...
      { kind: "mail", app: "Mail", to: "To: Priya", say: "Priya ko bolo deploy ho gaya, testing baaki hai", text: "Hi Priya — the deploy is done; testing is still pending." },
      { kind: "search", app: "Maps", say: "चाय की दुकान जो अभी खुली हो", text: "Chai shop open now" },
      { kind: "message", app: "WhatsApp", say: "dile a Marta que llego diez minutos tarde", text: "Marta, llego diez minutos tarde. ¿Pides por mí?" },
      { kind: "memo", app: "Notes", text: "Transfer 2500 rupees to Ramesh tomorrow." },
      { kind: "message", app: "Slack", say: "tell the team the PR is up, two files, no migrations", text: "PR is up — two files, no migrations. Reviews welcome." },
      { kind: "memo", app: "Reminders", say: "remind me to call Amma before nine", text: "Call Amma before 9." },
      { kind: "search", app: "YouTube", text: "きしむドアの直し方" },
      { kind: "mail", app: "Mail", to: "To: Landlord", say: "reply politely that rent goes out on the first", text: "Hello — the rent goes out on the first, as always. Thank you." },
      { kind: "message", app: "Message", say: "bol do hum paanch minute mein pahunch rahe hain", text: "We'll be there in five minutes." },
      { kind: "memo", app: "Notes", say: "liste de courses : lait, deux citrons, piles", text: "Lait, deux citrons, piles." },
      { kind: "message", app: "WhatsApp", say: "أخبر سامي أنني سأتأخر عشر دقائق", text: "سامي، سأتأخر عشر دقائق." },
    ],
  },
  desk: {
